...
namespace IviriusTextEditor.Pages
{
    public sealed partial class MainPage : Page
    {
        ...
        {
            _ = SysSender.TabItems.Remove(SysArgs.Tab);
            if (TabbedView.TabItems.Count == 0) // TODO 不再支持 Windows.UI.ViewManagement.ApplicationView。请改用 Microsoft.UI.Windowing.AppWindow。有关更多详细信息，请参阅 https://docs.microsoft.com/en-us/windows/apps/windows-app-sdk/migrate-to-windows-app-sdk/guides/windowing。
_ = await ApplicationView.GetForCurrentView().TryConsolidateAsync();
            CloseWarningBox3.Close();
        }
